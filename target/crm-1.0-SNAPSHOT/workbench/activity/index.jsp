...
<script type="text/javascript" src="jquery/bs_pagination/en.js"></script>
	...
	$(function(){
		...
		$("#savebtn").click(function (){
			alert("e2qe3rf")
			$.ajax({
				url: "activity/insertactivity.do",
				data: {
	...
	function pageList(pagenum,pagesize) {
		$.ajax({
			...
			data:{
				...
				"starttime":$.trim($("#select-startTime").val()),
				"endtime":$.trim($("#select-endTime").val())
			},
			dataType:"json",
			type:"get",
			success:function (data){
				...
				var  totalPages=data.totol%pagesize==0?data.totol/pagesize:parseInt(data.totol/pagesize)+1
				$("#activityPage").bs_pagination({
					currentPage: pagenum, // 页码
					rowsPerPage: pagesize, // 每页显示的记录条数
					maxRowsPerPage: 20, // 每页最多显示的记录条数
					totalPages: totalPages, // 总页数
					totalRows: data.totol, // 总记录条数
				...
				<form class="form-inline" role="form" style="position: relative;top: 8%; left: 5px;">
				  ...
				  <div class="form-group">
				    <div class="input-group">
					  ...
					  <input class="form-control" type="text" id="select-startTime" />
				    </div>
				  </div>
				  <div class="form-group">
				    <div class="input-group">
				      <div class="input-group-addon">结束日期</div>
					  <input class="form-control" type="text" id="select-endTime">
				    </div>
				  </div>
